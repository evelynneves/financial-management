    ...
    <Container className={styles.container} maxWidth={false}>
        <main className={styles.main}>
            ...
            <div className={styles.buttons}>
                <Button variant="contained" color="primary" className={styles.primaryButton}>Abrir conta</Button>
                <Button variant="outlined" color="primary" className={styles.outlinedButton}>Já tenho conta</Button>
            </div>
        </main>
